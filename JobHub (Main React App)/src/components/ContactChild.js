...
const ContactChild = ({
  ...
  return (
    <div className="contact-child">
      ...
      <div className="velstar-is-a-shopify-plus-agen-wrapper">
        <div className="here-at-velstar">{`The role will involve translating project specifications into clean, test-driven, easily maintainable code. You will work with the Project and Development teams as well as with the Technical Director, adhering closely to project plans and delivering work that meets functional & non-functional requirements. You will have the opportunity to create new, innovative, secure and scalable features for our clients on the Shopify platform`}</div>
      </div>
      <div className="velstar-is-a-shopify-plus-agen-wrapper">
      ...
      {/* <div className="requirements-parent">
        ...
        <div className="great-troubleshooting-and-container">
          <ul className="great-troubleshooting-and-anal">
            <li className="great-troubleshooting-and">
      ...
      <div className="requirements-parent">
        <div className="requirements">Desirable:</div>
        <div className="working-knowledge-of-container">
          <ul className="great-troubleshooting-and-anal">
            <li className="great-troubleshooting-and">
      ...
      <div className="early-finish-on-container">
        <ul className="great-troubleshooting-and-anal">
          <li className="great-troubleshooting-and">
          ...
          <li className="great-troubleshooting-and">Generous annual bonus.</li>
          <li className="great-troubleshooting-and">Healthcare package</li>
          <li className="great-troubleshooting-and">
          ...
          <li className="great-troubleshooting-and">Cycle 2 Work Scheme</li>
          <li className="great-troubleshooting-and">Brand new MacBook Pro</li>
          <li>
